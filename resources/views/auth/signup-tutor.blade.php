...
@section('title', 'Become a Tutor | Tutzy')
...
<main class="min-h-[85vh] flex items-center justify-center py-16 px-4 sm:px-6 bg-gradient-to-b from-[#fafaf8] to-white relative">
    ...
    <div class="absolute top-[30%] right-[10%] w-[500px] h-[500px] bg-orange-100/30 rounded-full blur-[100px] pointer-events-none"></div>
    ...
    <div class="w-full max-w-[480px] bg-white/90 backdrop-blur-md rounded-3xl p-8 sm:p-10 shadow-[0_8px_40px_rgba(0,0,0,0.04)] border border-gray-100 relative z-10">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-[28px] sm:text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Sign up as a tutor</h1>
            <p class="text-[15px] text-gray-500 font-medium">Teach students worldwide and grow with Tutzy.</p>
        </div>
        ...
        <form action="{{ route('signup.tutor.post') }}" method="POST" class="space-y-4">
            @csrf
            <div>
